...
namespace Denver.DataAccess
{
    public class DBManager
    {
        ...
        public IDbDataParameter CreateParameter(DbType dbType, string name, int size, object value)
        {
            return DataParameterManager.CreateParameter(providerName, name, size, value, dbType, ParameterDirection.Input);
        }

        public IDbDataParameter CreateParameter(DbType dbType, string name, int size, object value, ParameterDirection direction)
        {
